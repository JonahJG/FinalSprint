...
const Signup = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const data = { email, password, firstname, lastname, profilepicture, age, gender, birthday, job, city, province, country, relationship, bio };
    try {
    ...
    <div className="signupform">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <section className="requiredfields">
          ...
          <input type="text" value={profilepicture} required onChange={(e) => setProfilepicture(e.target.value)} />
          </section>
        <section className="requiredfields">
          <label>Enter your age: </label>
          <input type="text" value={age} required onChange={(e) => setAge(e.target.value)} />
        </section>
        <section className="requiredfields">
        ...
        <section className="requiredfields">
          ...
          <input type="text" value={birthday} required onChange={(e) => setBirthday(e.target.value)} />
        </section>
        <section className="requiredfields">
          <label>Enter your occupation: </label>
          <input type="text" value={job} required onChange={(e) => setJob(e.target.value)} />
        </section>
        <section className="requiredfields">
        ...
        <section className="requiredfields">
          ...
          <input type="text" value={relationship} required onChange={(e) => setRelationship(e.target.value)} />
        </section>
        <section className="requiredfields">
          <label>Tell us a few things about yourself: </label>
          <input type="text" value={bio} required onChange={(e) => setBio(e.target.value)} />
        </section>
        <section className="requiredfields">
